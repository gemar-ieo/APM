...
![Flowchart of the APM tool workflow, illustrating the sequential stages from bathymetry optimization to the final extraction of geomorphometric parameters.](workflow.png)
